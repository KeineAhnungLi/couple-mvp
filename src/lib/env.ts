...
export const env = {
  ...
  NOTIFICATION_CRON_SECRET: readEnv("NOTIFICATION_CRON_SECRET"),
  WEB_PUSH_VAPID_PUBLIC_KEY: readEnv("WEB_PUSH_VAPID_PUBLIC_KEY"),
  WEB_PUSH_VAPID_PRIVATE_KEY: readEnv("WEB_PUSH_VAPID_PRIVATE_KEY"),
  WEB_PUSH_SUBJECT: readEnv("WEB_PUSH_SUBJECT"),
};
